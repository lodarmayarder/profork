...
BASE_URL="https://github.com/profork/profork/raw/master/webapps"

# Create the ~/webapps directory
mkdir -p ~/webapps

# Download the specified scripts into ~/webapps
curl -L https://github.com/profork/profork/raw/master/webapps/native.sh -o ~/webapps/native.sh
curl -L https://github.com/profork/profork/raw/master/webapps/nlaunch.sh -o ~/webapps/nlaunch.sh
curl -L https://github.com/profork/profork/raw/master/webapps/chrome.sh -o ~/webapps/chrome.sh
curl -L https://github.com/profork/profork/raw/master/webapps/webapps.sh -o ~/webapps/webapps.sh
...
curl -L https://github.com/profork/profork/raw/master/webapps/Add-WebApp.sh -o /userdata/roms/webapps/+ADD-WEB-APPS.sh
...
curl -L https://github.com/profork/profork/raw/master/webapps/es_systems_webapps.cfg -o ~/configs/emulationstation/es_systems_webapps.cfg
curl -L https://github.com/profork/profork/raw/master/webapps/es_features_webapps.cfg -o ~/configs/emulationstation/es_features_webapps.cfg
