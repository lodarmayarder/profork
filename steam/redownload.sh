...
wget -q --tries=30 --no-check-certificate --no-cache --no-cookies -O /userdata/system/pro/steam/batocera-conty-patcher.sh https://github.com/profork/profork/raw/main/main/steam/build/batocera-conty-patcher.sh
