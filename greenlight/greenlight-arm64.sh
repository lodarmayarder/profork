...
#       DEFINE APP INFO >> 
APPNAME=greenlight
APPLINK=https://github.com/profork/profork/releases/download/r1/greenlight.aarch64.tar.gz
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/profork/profork/raw/master/greenlight/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O "/userdata/roms/ports/Greenlight.sh.keys" "https://github.com/profork/profork/raw/master/xcloud/extra/xcloud.sh.keys"
# --------------------------------------------------------------------
