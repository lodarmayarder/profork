...
url=https://github.com/profork/profork/raw/main/.dep
...
wget -q -O $pro/$appname/extra/icon.png https://github.com/profork/profork/raw/main/$appname/extra/icon.png; chmod a+x $dep/tput; cd ~/
# --------------------------------------------------------------------
# // end of dependencies 
#
# --------------------------------------------------------------------
...
url=https://github.com/profork/profork/raw/main/
