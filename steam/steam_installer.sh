...
APPLINK=https://github.com/profork/profork/releases/download/r1/steam.sh
...
wget --tries=3 --timeout=10 --no-check-certificate -q -O $icon https://github.com/profork/profork/raw/master/steam/extra/icon.png
