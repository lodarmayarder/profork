...
url=https://github.com/profork/profork/raw//
cd $temp
...
wget -q -O "/userdata/roms/ports/ludusavi.sh.keys" "https://github.com/profork/profork/raw/master/ludusavi/extra/ludusavi.sh.keys"
# --------------------------------------------------------------------
