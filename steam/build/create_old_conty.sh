...
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/libunionfs.so" "https://github.com/profork/proforkblob/main/steam/build/unionfs/libunionfs.so"
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/unionfsctl" "https://github.com/profork/proforkblob/main/steam/build/unionfs/unionfsctl"
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/unionfs3" "https://github.com/profork/proforkblob/main/steam/build/unionfs/unionfs3"
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/unionfs" "https://github.com/profork/proforkblob/main/steam/build/unionfs/unionfs"
...
"curl -Ls https://github.com/profork/profork/raw/main/main/steam/build/libc-dthash-patch.sh | bash && exit"
# ------------------------------------------------------------------------------------------
