...
URL="https://github.com/profork/profork/releases/download/r1/Space_Quest_3d.wsquashfs"
KEYS_URL="https://github.com/profork/profork/releases/download/r1/Space_Quest_3d.wsquashfs.keys"  # Leave empty if no keys file is needed
