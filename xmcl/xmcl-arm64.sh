...
if [ ! -f "$LIBREWOLF_APPIMAGE" ]; then
    ...
    sleep 3
    curl -L https://github.com/profork/profork/raw/master/librewolf/install_arm64.sh | bash
fi
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/profork/profork/raw/master/xmcl/extra/xmcl.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O $icon https://github.com/profork/profork/raw/master/xmcl/extra/xmcl.png
# //
