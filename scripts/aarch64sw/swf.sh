...
curl -# -o "$UPDATE_SCRIPT" "https://github.com/profork/profork/raw/master/scripts/aarch64sw/UPDATE-SHORTCUTS.sh"
...
curl -# -o "$ES_CONFIG_DIR/es_features_citron.cfg" "https://github.com/profork/profork/raw/master/scripts/aarch64sw/es_features_citron.cfg"
echo "Downloaded: es_features_citron.cfg"
# For Ryujinx, using the same config file for now:
curl -# -o "$ES_CONFIG_DIR/es_features_ryujinx.cfg" "https://github.com/profork/profork/raw/master/scripts/aarch64sw/es_features_citron.cfg"
