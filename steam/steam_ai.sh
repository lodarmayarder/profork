...
echo 'LD_LIBRARY_PATH="/userdata/system/pro/.dep:${LD_LIBRARY_PATH}" DISPLAY=:0.0 RIM_ALLOW_ROOT=1 /userdata/system/pro/'$appname'/'$appname'.AppImage -gamepadui "$@"' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
