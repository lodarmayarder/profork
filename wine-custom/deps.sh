...
for tag in $selected; do
  case "$tag" in
    ...
    "steamy")
      ...
      curl -Ls https://github.com/profork/profork/raw/master/wine-custom/steamy.sh | bash
      ;;
    *)
...
sleep 2
curl -L https://github.com/profork/profork/raw/master/wine-custom/wine.sh | bash
