...
case $CHOICE in
    1)
        ...
        curl -L https://github.com/profork/profork/raw/master/wine-custom/vanilla.sh | bash
        ;;
    2)
        echo "You chose Wine-tkg staging."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/tkg.sh | bash
        ;;
    3)
        echo "You chose Wine-GE Custom."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/wine-ge.sh | bash
        ;;
    4)
        echo "You chose GE-Proton."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/ge-proton.sh | bash
        ;;
    5)
        echo "You chose Prepare installers next run."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/deps.sh | bash
        ;;
    6)
        echo "You chose Easy Batocera Wine Tricks."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/tricks.sh | bash
        ;;
    7)
        echo "You chose Easy autorun.cmd creator."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/ar.sh | bash
        ;;
    8)
        echo "You chose to convert a .pc folder to a .wine folder."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/wc.sh | bash
        ;;
    9)
        echo "You chose to compress a .wine folder to a .wsquashfs or .tgz file."
        curl -L https://github.com/profork/profork/raw/master/wine-custom/squash.sh | bash
        ;;
    10)
        echo "You chose to decompress a .wsquashfs or .tgz file. to a.wine"
        curl -L https://github.com/profork/profork/raw/master/wine-custom/unsquash.sh | bash
        ;;
    99)
        echo "Exiting..."
        exit
