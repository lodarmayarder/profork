...
wget https://github.com/profork/profork/raw/master/bedrock/shortcut/Minecraft-Bedrock.sh -O /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1 && chmod +x /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1
echo "DONE"
sleep 3
