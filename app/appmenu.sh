...
declare -A apps
apps=(
    ["2SHIP2HARKINIAN"]="curl -Ls https://github.com/profork/profork/raw/master/soh/2s2h.sh | bash"
    ...
    ["ARCADE-MANAGER"]="curl -Ls https://github.com/profork/profork/raw/master/arcade-manager/arcade.sh | bash"
    ["ARCH-DESKTOP-MODE"]="curl -Ls https://github.com/profork/profork/raw/master/runimage/rimdesk.sh | bash"    
    ...
    ["BOTTLES/AMD-INTEL-GPUS-ONLY"]="curl -Ls https://github.com/profork/profork/raw/master/bottles/bottles.sh | bash"
    ...
    ["CLONE-HERO"]="curl -LS https://github.com/profork/profork/raw/master/clonehero/clonehero.sh | bash"
    ...
    ["FIREFOX"]="curl -Ls https://github.com/profork/profork/raw/master/firefox/firefox.sh | bash"
    ...
    ["GIMP"]="curl -Ls https://github.com/profork/profork/raw/master/gimp/gimp.sh | bash"
    ["GREENLIGHT"]="curl -Ls https://github.com/profork/profork/raw/master/greenlight/greenlight.sh | bash"
    ["HANDBRAKE"]="curl -Ls https://github.com/profork/profork/raw/master/handbrake/hb.sh | bash"
    ["HARD-INFO"]="curl -Ls https://github.com/profork/profork/raw/master/hardinfo/hardinfo.sh | bash"
#    ["HYDORAH"]="curl -Ls https://github.com/profork/profork/raw/master/hydorah/hydorah.sh | bash" 
    ...
    ["LIBREWOLF"]="curl -Ls https://github.com/profork/profork/raw/master/librewolf/install_x86_64.sh | bash"
    ["LUANTI"]="curl -Ls https://github.com/profork/profork/raw/master/luanti/extra/lua.sh | bash"
    ["LUDUSAVI"]="curl -Ls https://github.com/profork/profork/raw/master/ludusavi/ludusavi.sh | bash"
    ["LUTRIS/AMD-INTEL-GPUS-ONLY"]="curl -Ls https://github.com/profork/profork/raw/master/lutris/lutris.sh | bash"
    ["MEDIAELCH"]="curl -Ls https://github.com/profork/profork/raw/master/mediaelch/mediaelch.sh | bash"
#    ["MINECRAFT-BEDROCK-EDITION"]="curl -Ls https://github.com/profork/profork/raw/master/bedrock/install.sh"
    ...
    ["OPENGOAL"]="curl -Ls https://github.com/profork/profork/raw/master/opengoal/og.sh | bash"
 #   ["OPEN-RA-TIBERIAN-DAWN"]="curl -Ls https://github.com/profork/profork/raw/master/openra/td.sh | bash"
 #   ["OPEN-RA-RED-ALERT"]="curl -Ls https://github.com/profork/profork/raw/master/openra/ra.sh | bash"
 #   ["OPEN-RA-DUNE-2000"]="curl -Ls https://github.com/profork/profork/raw/master/openra/d2k.sh | bash"
    ["OPERA"]="curl -Ls https://github.com/profork/profork/raw/master/opera/opera.sh | bash"
    ["PARSEC/CONTAINER"]="curl -Ls https://github.com/profork/profork/raw/master/parsec/parsec.sh | bash"
    ["PCSX2-LATEST"]="curl -Ls https://github.com/profork/profork/raw/master/pcsx2/pcsx2.sh | bash"
    ...
    ["PRISM-LAUNCHER"]="curl -Ls https://github.com/profork/profork/raw/master/prismlauncher/prism.sh | bash"
    ...
    ["PS3PLUS"]="curl -Ls https://github.com/profork/profork/raw/master/ps3plus/installer.sh | bash"
    ["PS4"]="curl -Ls https://github.com/profork/profork/raw/master/shadps4/shadps4.sh | bash"
    ...
    ["SECRET-EMULATOR"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/secret.sh | bash"
    ["SHIP-OF-HARKINIAN"]="curl -Ls https://github.com/profork/profork/raw/master/soh/soh2.sh | bash"
    ...
    ["SPAGHETTIKART"]="curl -Ls https://github.com/profork/profork/raw/master/spaghettikart/spagehttikart.sh | bash"
    ["STARSHIP"]="curl -Ls https://github.com/profork/profork/raw/master/soh/starship.sh | bash"
    ["STEAM"]="curl -Ls https://github.com/profork/profork/raw/master/steam/steam_ai.sh | bash"
    ["STRAWBERRY-MUSIC-PLAYER"]="curl -Ls https://github.com/profork/profork/raw/master/strawberry/strawberry.sh | bash"
...
#   ["SUNSHINE"]="curl -Ls https://github.com/profork/profork/raw/master/sunshine/installer.sh | bash"
    ["SUPER-MARIO-BROS-REMASTERED"]="curl -Ls  https://github.com/profork/profork/raw/master/smbr/smbr.sh | bash"
    ["TABBY"]="curl -Ls https://github.com/profork/profork/raw/master/tabby/tabby.sh | bash"
    ["TELEGRAM"]="curl -Ls https://github.com/profork/profork/raw/master/telegram/telegram.sh | bash"
    ["TOTAL-COMMANDER"]="curl -Ls https://github.com/profork/profork/raw/master/totalcmd/totalcmd.sh | bash"
    ["UNLEASED-RECOMP"]="curl -Ls https://github.com/profork/profork/raw/master/unleased-recomp/unleashed.sh | bash" 
  #  ["VIBER"]="curl -Ls  https://github.com/profork/profork/raw/master/viber/viber.sh | bash"
...
app_desc=(
    ...
    ["ARCH-DESKTOP-MODE"]="Arch XFCE Desktop inside Runimage container"
...
#   ["HYDORAH"]="2010 Windows Shmup game"
 ...
 #   ["MINECRAFT-BEDROCK-EDITION"]="Cross-platform version of Minecraft"
    ...
    ["PCSX2-LATEST"]="Latest Version of PS2 emulator for All versions of Batocera"
    ...
    ["PS2PLUS"]="Legacy Batocera.Pro Latest version of the PCSX2 emulator for v40 and Lower"
    ["PS3PLUS"]="Legacy Batocera.Pro Latest RPCS3 PlayStation 3 emulator for v40 and Lower"
    ...
    ["SPAGHETTIKART"]="Open Source port of Mario Kart 64 Engine"
    ...
    ["SUPER-MARIO-BROS-REMASTERED"]="Open source Super Mario Bros. Remake"
  ...
  #  ["VIBER"]="Messaging and calling app"
    ...
    ["WIIUPLUS"]="Legacy Batocera.Pro Newest CEMU build of Wii U emulator for v40 and lower"
