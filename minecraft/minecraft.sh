...
APPLINK=https://github.com/profork/profork/raw/master/minecraft/extra/Minecraft
...
curl --progress-bar --remote-name --location "https://github.com/profork/profork/raw/master/$appname/extra/$p1"
curl --progress-bar --remote-name --location "https://github.com/profork/profork/raw/master/$appname/extra/$p2"
curl --progress-bar --remote-name --location "https://github.com/profork/profork/raw/master/$appname/extra/$p3"
# libselinux.so.1
d2=libselinux.so.1
wget -q -O /userdata/system/pro/minecraft/extra/$d2 https://github.com/profork/profork/raw/master/$appname/extra/$d2
ln -s /userdata/system/pro/minecraft/extra/$d2 /lib/$d2 2>/dev/null
# tar
d3=tar
wget -q -O /userdata/system/pro/minecraft/extra/$d3 https://github.com/profork/profork/raw/master/$appname/extra/$d3
chmod a+x $d3 
#
d4=libsecret-1.so.0
wget -q -O /userdata/system/pro/minecraft/extra/$d4 https://github.com/profork/profork/raw/master/$appname/extra/$d4
# --- join liblauncher
...
wget -q -O "/userdata/roms/ports/Minecraft.sh.keys" "https://github.com/profork/profork/raw/master/minecraft/extra/Darknior-Minecraft.sh.keys" 
