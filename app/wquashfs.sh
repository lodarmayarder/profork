...
apps=(
    ...
    ["Portaboy/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/portaboy.sh | bash"
    ["Teather-N-Feather/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/tnf.sh | bash"
    ["The-Ur-Quan-Masters/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/uqm.sh | bash"
    ["MEGAMAN-X8-16-BIT-DEMAKE/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/megamanx8.sh | bash"
    ["SHEEPY-A-SHORT-ADVENTURE/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/sheepy.sh | bash"
    ["SPACE-QUEST-3D/SQ3-REMAKE/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/sq3d.sh | bash"
    ["STARFIGHTER-MOVIE-ARCADE-GAME/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/starfighter.sh | bash"
    ["STRATOSPEAR-JAM/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/sj.sh | bash"
    ["AM2R/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/a2r.sh | bash"
    ["Z2-ADV-OF-LNK-Remake/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/z2r.sh | bash"
    ["TLOZ-DUNGEONS-OF-INFINITY/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/doi.sh | bash"
    ["HYDORA/WINDOWS-IN-CONTAINER"]="curl -Ls https://github.com/profork/profork/raw/master/hydorah/hydorah.sh | bash"
    ["CRASH-BANDICOOT-BACK-IN-TIME/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/cbit.sh | bash"
    ["MODERN-MODERN-CHEF/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/mmc.sh | bash"
    ["SONIC-TRIPLE-TROUBLE/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/stt.sh | bash"
    ["TMNT-RESCUE-PALOOZA/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/tmntrp | bash"
    ["MEGA-MAN-AGAIN/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/mma.sh | bash"
    ["STREET-FIGHTER-X-MEGA-MAN/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/sfxmm.sh | bash"
    ["SONIC-AND-THE-FALLEN-STAR/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/safs.sh | bash"
    ["TROGDOR-REBURNIATED/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/tr.sh | bash"
    ["PULLYWOGTOG/WINDOWS"]="curl -Ls https://github.com/profork/profork/releases/download/r1/pullyWogPog.wtgz | bash"
    ["SUPERCRATEBOX/WINDOWS"]="curl -Ls https://github.com/profork/profork/releases/download/r1/SuperCratebox.wtgz | bash"
    ["MEGAMAN-ROCK-N-ROLL/LINUX"]="curl -Ls https://github.com/profork/profork/raw/master/windows/mmrnr.sh | bash"
    ["GLOBEBA/WINDOWS"]="curl -Ls https://github.com/profork/profork/raw/master/windows/glba.sh | bash"
    ["FLARE-RPG/LINUX"]="curl -Ls https://github.com/profork/profork/raw/master/openra/flare.sh | bash"
    ["OPENRA-CNC-TIBERIAN-DAWN/LINUX"]="curl -Ls https://github.com/profork/profork/raw/master/openra/td.sh | bash"
    ["OPENRA-CNC-RED-ALERT/LINUX"]="curl -Ls https://github.com/profork/profork/raw/master/openra/ra.sh | bash"
    ["OPENRA-DUNE-2000/LINUX"]="curl -Ls https://github.com/profork/profork/raw/master/openra/d2k.sh | bash"
...
descriptions=(
    ...
    ["Apotris/LINUX"]="A fast-paced, minimalist Tetris-like block game."
    ...
    ["FLARE-RPG/LINUX"]="A free open-source Diablo-style RPG"
    ["CASTLEVANIA-2-SIMONS-QUEST-REVAMPED/WINDOWS"]="Fan remake of Castlevania 2 with better graphics and controls."
