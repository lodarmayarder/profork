...
URL="https://github.com/profork/profork/releases/download/r1/DK_Advanced.wtgz"
KEYS_URL="https://github.com/profork/profork/releases/download/r1/DK_Advanced.wtgz.keys"  # Leave empty if no keys file is needed
