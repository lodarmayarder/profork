...
download_prebuilt() {
    ...
    curl -L https://github.com/profork/profork/raw/master/steam/install2.sh | bash
}

# Function to build container from scratch
build_from_scratch() {
    echo "Building Up-to-Date Container from Scratch..."
    curl -L https://github.com/profork/profork/raw/master/steam/install_new.sh | bash
}

# Function to install Steam only mini container (AMD/INTEL GPU ONLY)
install_steam_mini() {
    echo "Installing Steam Only Mini Container..."
    curl -L  https://github.com/profork/profork/raw/master/steam/steam_installer.sh| bash
}

# Function to install Lutris only mini container (AMD/INTEL GPU ONLY)
install_lutris_mini() {
    echo "Installing Lutris Only Mini Container..."
    curl -L  https://github.com/profork/profork/raw/master/lutris/lutris.sh | bash
}
...
install_minecraft_mini() {
    ...
    curl -L https://github.com/profork/profork/raw/master/bedrock/install.sh | bash
}
# Function to install Bottles mini container (AMD/INTEL GPU ONLY)
install_bottles_mini() {
    echo "Installing Bottles Mini Container..."
    curl -L https://github.com/profork/profork/raw/master/bottles/bottles.sh | bash
}

https://github.com/profork/profork/blob/master/bottles/bottles.sh
# Display the menu
while true; do
    CHOICE=$(dialog --clear \
