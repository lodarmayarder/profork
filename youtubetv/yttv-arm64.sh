...
#       DEFINE APP INFO >> 
APPNAME=youtubetv 
APPLINK=https://github.com/profork/profork/releases/download/r1/YouTubeonTV-linux-aarch64.zip
...
wget -q -O "/userdata/roms/ports/YoutubeTV.sh.keys" "https://github.com/profork/profork/raw/master/youtubetv/extra/YoutubeTV.sh.keys"
# --------------------------------------------------------------------
