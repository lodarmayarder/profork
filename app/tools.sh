...
animate_title() {
    local text="Tools - Thanks to UUreel for some of the scripts"
    local delay=0.03
    local length=${#text}
...
apps=(
    ...
    ["ARIA2C"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/aria2c.sh | bash"
    ["BATOCERA-CLI/RUN-TO-SEE-ENCLOSED-TOOLS"]="curl -Ls https://github.com/profork/profork/raw/master/docker/cli_install.sh | bash"
...
#    ["DECKY/FOR-ARCH-&-FLATPAK-STEAM"]="curl -Ls https://raw.githubusercontent.com/trashbus99/profork/refs/heads/master/scripts/decky.sh | bash"
    ["EFIBOOTMGR-EASY-REBOOT-OTHER-OS"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/ei.sh | bash"
    ["LIVECAPTIONS/SERVICE"]="curl -Ls https://github.com/profork/profork/raw/master/livecaptions/livecaptions.sh | bash"
    ["RESTORE-MAME2010/MAME0139-TO-v41+"]="curl -Ls https://github.com/profork/profork/raw/master/mame2010_v41+/2010.sh | bash"
    ["NVTOP"]="curl -Ls https://github.com/profork/profork/raw/master/nvtop/nvtop.sh | bash"
    ["PS3-TOOLS"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/ps3a.sh | bash"
  #  ["SUNSHINE-CONTAINER"]="curl -Ls https://github.com/profork/profork/raw/master/sunshine/installer.sh | bash"
    ["SUNSHINE-FLATPAK"]="curl -Ls https://github.com/profork/profork/raw/master/flatpak/install_sunshine.sh | bash"
    ["WINE-CUSTOM-DOWNLOADER/v40+"]="curl -Ls https://github.com/profork/profork/raw/master/wine-custom/wine.sh | bash"
    ["ADD-EMULATOR-CONFIGS-TO-EMULATIONSTATION"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/emgen/emgen.sh | bash"
    ["TESSERACT"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/tesseract.sh | bash"
    ["PKGX"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/pkgx.sh | bash"
    ["SYSTEM-GAMEBOOT-SPLASH-VIDEOS"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/splash.sh | bash"
    ["WINE-GE-8-26"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/ge.sh | bash"
    ["XMLSTARLET"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/xmlstarlet.sh | bash"
    ["XDOTOOL"]="curl -Ls https://github.com/profork/profork/raw/master/scripts/xdotool.sh | bash"
...
curl -Ls https://github.com/profork/profork/raw/master/app/tools.sh | bash
