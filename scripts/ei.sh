...
curl -Ls https://github.com/profork/profork/raw/master/scripts/efi.sh -o "$EFI_SCRIPT_PATH"
if [ $? -ne 0 ]; then
...
curl -Ls https://github.com/profork/profork/raw/master/app/bkeys.txt -o "$PORTS_KEYS"
if [ $? -ne 0 ]; then
