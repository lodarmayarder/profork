...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/profork/profork/raw/master/strawberry/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
