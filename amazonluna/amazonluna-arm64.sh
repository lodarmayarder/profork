...
#       DEFINE APP INFO >> 
APPNAME=luna 
APPLINK=https://github.com/profork/profork/releases/download/r1/luna.aarch64.tar.gz
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/profork/profork/raw/master/amazonluna/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O "/userdata/roms/ports/Amazon-Luna.sh.keys" "https://github.com/profork/profork/raw/master/xcloud/extra/xcloud.sh.keys"
# --------------------------------------------------------------------
