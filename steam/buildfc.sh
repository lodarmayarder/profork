...
curl -Ls https://github.com/profork/profork/raw/master/steam/build/compress.sh -o compress.sh
curl -Ls https://github.com/profork/profork/raw/master/steam/build/conty-start.sh -o conty-start.sh
curl -Ls https://github.com/profork/profork/raw/master/steam/build/createfc.sh -o createfc.sh
...
# Update shortcuts
wget -q --tries=30 --no-check-certificate --no-cache --no-cookies --tries=50 -O /tmp/update_shortcuts.sh https://github.com/profork/profork/raw/master/steam/update_shortcuts.sh
