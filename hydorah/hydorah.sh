...
sleep 3
curl -Ls https://github.com/profork/profork/raw/master/docker/install_no_portainer.sh | bash
clear 
...
APPLINK=https://github.com/profork/profork/releases/download/r1/Hydorah.flatimage
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/profork/profork/raw/master/hydorah/extra/Hydorah.jpg; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O $icon https://github.com/profork/profork/raw/master/hydorah/extra/Hydorah.jpg
# //
