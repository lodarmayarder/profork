...
if [ "$architecture" != "aarch64" ]; then
    echo "This script only runs on aarch64 CPUs, not on $architecture."
    exit 1
fi
...
apps=(
    ...
    ["CASAOS/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/casa2.sh | bash"
    # ["CASAOS/FULL-CONTAINER/DEBIAN/XFCE"]="curl -Ls https://github.com/profork/profork/raw/master/docker/casa.sh | bash"
    ["EMBY-SERVER/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/emby.sh | bash"
    ["JELLYFIN-SERVER/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/jellyfin.sh | bash"
   # ["LINUX-DESKTOPS-RDP/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/rdesktop.sh | bash | bash"
   # ["NETBOOT-XYZ-SERVER/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/netboot.sh | bash"
    ["NEXTCLOUD-SERVER/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/nextcloud.sh | bash" 
    ["PLEX-SERVER/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/plex.sh | bash"
    ["DOCKER/PORTAINER/ONLY"]="curl -Ls https://github.com/profork/profork/raw/master/docker/install-aarch64.sh | bash"
    ["UMBREL-OS/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/umbrel.sh | bash"
   # ["WINDOWS-VMS/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/win.sh | bash"
   # ["LINUX-DESKTOPS-WEB/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/webtop.sh | bash"
    ["SYSTEMTOOLS-WETTY-GLANCES-FILEMANAGER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/systools.sh | bash"
   # ["LINUX-VMS-QEMU/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/qemu.sh | bash"
   # ["LINUX-VMS-QEMU-ARM64/DOCKER"]="curl -Ls https://github.com/profork/profork/raw/master/docker/qemu-arm.sh | bash"
    # Add other apps here
)
