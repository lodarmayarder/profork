...
dialog --msgbox "✅ PCSX2 installation nearly complete!\n\n⚙️ Configure PCSX2 via its GUI including controller mappings, achievements, and BIOS.\n📜 After configuring, generate launch shortcuts by running:\n\n🕹️ UPDATE-PS2-SHORTCUTS parser in the PCSX2 PS2 menu in EmulationStation.  You should update PCSX2 by rerunning this script. If you use the built in updater, the Launchers may not work" 20 50
